...
var _gsScope="undefined"!=typeof module&&module.exports&&"undefined"!=typeof global?global:this||window;(_gsScope._gsQueue||(_gsScope._gsQueue=[])).push(function(){"use strict";function e(e,t,i,n,a,r){return i=(parseFloat(i||0)-parseFloat(e||0))*a,n=(parseFloat(n||0)-parseFloat(t||0))*r,Math.sqrt(i*i+n*n)}function t(e){return"string"!=typeof e&&e.nodeType||(e=_gsScope.TweenLite.selector(e),e.length&&(e=e[0])),e}function i(e,t,i){var n,a,r=e.indexOf(" ");return-1===r?(n=void 0!==i?i+"":e,a=e):(n=e.substr(0,r),a=e.substr(r+1)),n=-1!==n.indexOf("%")?parseFloat(n)/100*t:parseFloat(n),a=-1!==a.indexOf("%")?parseFloat(a)/100*t:parseFloat(a),n>a?[a,n]:[n,a]}function n(i){if(!i)return 0;i=t(i);var n,a,r,o,s,c,u,h=i.tagName.toLowerCase(),d=1,p=1;"non-scaling-stroke"===i.getAttribute("vector-effect")&&(p=i.getScreenCTM(),d=p.a,p=p.d);try{a=i.getBBox()}catch(f){}if(a&&(a.width||a.height)||"rect"!==h&&"circle"!==h&&"ellipse"!==h||(a={width:parseFloat(i.getAttribute("rect"===h?"width":"circle"===h?"r":"rx")),height:parseFloat(i.getAttribute("rect"===h?"height":"circle"===h?"r":"ry"))},"rect"!==h&&(a.width*=2,a.height*=2)),"path"===h)o=i.style.strokeDasharray,i.style.strokeDasharray="none",n=i.getTotalLength()||0,d!==p&&console.log("Warning: <path> length cannot be measured accurately when vector-effect is non-scaling-stroke and the element isn't proportionally scaled."),n*=(d+p)/2,i.style.strokeDasharray=o;else if("rect"===h)n=2*a.width*d+2*a.height*p;else if("line"===h)n=e(a.x,a.y,a.x+a.width,a.y+a.height,d,p);else if("polyline"===h||"polygon"===h)for(r=i.getAttribute("points").match(l)||[],"polygon"===h&&r.push(r[0],r[1]),n=0,s=2;s<r.length;s+=2)n+=e(r[s-2],r[s-1],r[s],r[s+1],d,p)||0;else("circle"===h||"ellipse"===h)&&(c=a.width/2*d,u=a.height/2*p,n=Math.PI*(3*(c+u)-Math.sqrt((3*c+u)*(c+3*u))));return n||0}function a(e,i){if(!e)return[0,0];e=t(e),i=i||n(e)+1;var a=s(e),r=a.strokeDasharray||"",o=parseFloat(a.strokeDashoffset),l=r.indexOf(",");return 0>l&&(l=r.indexOf(" ")),r=0>l?i:parseFloat(r.substr(0,l))||1e-5,r>i&&(r=i),[Math.max(0,-o),Math.max(0,r-o)]}var r,o=_gsScope.document,s=o.defaultView?o.defaultView.getComputedStyle:function(){},l=/(?:(-|-=|\+=)?\d*\.?\d*(?:e[\-+]?\d+)?)[0-9]/gi,c=-1!==((_gsScope.navigator||{}).userAgent||"").indexOf("Edge");r=_gsScope._gsDefine.plugin({propName:"drawSVG",API:2,version:"0.1.5",global:!0,overwriteProps:["drawSVG"],init:function(e,t,r,o){if(!e.getBBox)return!1;var l,u,h,d,p=n(e)+1;return this._style=e.style,"function"==typeof t&&(t=t(o,e)),t===!0||"true"===t?t="0 100%":t?-1===(t+"").indexOf(" ")&&(t="0 "+t):t="0 0",l=a(e,p),u=i(t,p,l[0]),this._length=p+10,0===l[0]&&0===u[0]?(h=Math.max(1e-5,u[1]-p),this._dash=p+h,this._offset=p-l[1]+h,this._addTween(this,"_offset",this._offset,p-u[1]+h,"drawSVG")):(this._dash=l[1]-l[0]||1e-6,this._offset=-l[0],this._addTween(this,"_dash",this._dash,u[1]-u[0]||1e-5,"drawSVG"),this._addTween(this,"_offset",this._offset,-u[0],"drawSVG")),c&&(d=s(e),u=d.strokeLinecap,"butt"!==u&&u!==d.strokeLinejoin&&(u=parseFloat(d.strokeMiterlimit),this._addTween(e.style,"strokeMiterlimit",u,u+1e-4,"strokeMiterlimit"))),!0},set:function(e){this._firstPT&&(this._super.setRatio.call(this,e),this._style.strokeDashoffset=this._offset,1===e||0===e?this._style.strokeDasharray=this._offset<.001&&this._length-this._dash<=10?"none":this._offset===this._dash?"0px, 999999px":this._dash+"px,"+this._length+"px":this._style.strokeDasharray=this._dash+"px,"+this._length+"px")}}),r.getLength=n,r.getPosition=a}),_gsScope._gsDefine&&_gsScope._gsQueue.pop()(),function(e){"use strict";var t=function(){return(_gsScope.GreenSockGlobals||_gsScope)[e]};"undefined"!=typeof module&&module.exports?(require("gsap/TweenLite"),module.exports=t()):"function"==typeof define&&define.amd&&define(["gsap/TweenLite"],t)}("DrawSVGPlugin");
